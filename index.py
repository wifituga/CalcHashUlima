...
class MD5(object):
    ...
    def _step_1(cls):
        ...
        #CONVERTIR EL STRING A UN ARREGLO DE BITS
        ...
        #AGREGAR UN 1 Y MÚLTIPLES 0s HASTA QUE SEA CONGRUENTE A 64 
        bit_array.append(1)
        ...
        #RETORNA NUEVO ARREGLO DE BITS ESCOGIDO DESDE MENOS SIGNIFICATIVO
    ...
    def _step_2(cls, step_1_result):
        ...
        #CALCULAR EL RESIDUO DE LA LONGITUD EN BITS DEL ARREGLO CON 2^64 BITS
        length = (len(cls._string) * 8) % pow(2, 64)
        #CONFIGURAR ARREGLO DE BITS PARA QUE ESCOJA POR MENOR SIGNIFICATIVO
        length_bit_array = bitarray(endian="little")
        #ESCOGER BITS MENOS SIGNIFICATIVOS QUE SEAN CONGRUENTES CON EL RESIDUO
        length_bit_array.frombytes(struct.pack("<Q", length))

        result = step_1_result.copy()
        result.extend(length_bit_array)
        #RETORNAR BITS DE STRING PASO 1 + BITS ESCOGIDOS DEL PASO 2
        return result
    ...
    def _step_3(cls):
        ...
        #CREAR BUFFERS DEFAULT CON BITS DE MENOR PESO PRIMERO
